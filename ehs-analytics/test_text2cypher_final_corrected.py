#!/usr/bin/env python3
"""
Final Corrected Text2Cypher Test Script - Handles RetrievalResult properly
"""
    ...
    try:
        ...
        for i, query in enumerate(test_queries):
            ...
            try:
                ...
                if retrieval_result:
                    # Get the data from RetrievalResult
                    results_data = retrieval_result.data if hasattr(retrieval_result, 'data') else []
                    cypher_query = retrieval_result.metadata.get('cypher_query', 'Not available') if hasattr(retrieval_result, 'metadata') else 'Not available'
...
if __name__ == '__main__':
    result, _ = asyncio.run(run_comprehensive_test())
