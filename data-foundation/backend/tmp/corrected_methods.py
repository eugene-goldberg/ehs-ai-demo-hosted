    def _execute_query(self, query: str, parameters: Dict[str, Any] = None):
        ...
        if self.neo4j_client:
            ...
            try:
                ...
                self.logger.error(f"Error executing query with Neo4j client: {e}")
                raise
        else:
            # Use fallback driver
    ...
    def get_electricity_context(self, site: Optional[str], 
        ...
        try:
            ...
            self.logger.error(f"Error fetching electricity context: {e}")
            return {
                "site": site,
                "period": {"start": start_date, "end": end_date},
                "error": str(e),
    ...
    def get_water_context(self, site: Optional[str], 
        ...
        try:
            ...
            self.logger.error(f"Error fetching water context: {e}")
            return {
                "site": site,
                "period": {"start": start_date, "end": end_date},
                "error": str(e),
